...
Hardware::Hardware() :	_gpio(),
						...
						_rmtLeds(&_gpio, Gpio::GpioIndex::Gpio33, RmtChannel::RmtChannel1, Hal::BitsPerLed * Hal::MaxAddressableLeds, Hal::BitsPerLed),
						_rmtRemoteControl(&_gpio, Gpio::GpioIndex::Gpio2, RmtChannel::RmtChannel0, Hal::BitsPerLed * Hal::MaxAddressableLeds, Hal::BitsPerLed),
