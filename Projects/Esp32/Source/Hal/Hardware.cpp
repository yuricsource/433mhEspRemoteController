...
Hardware::Hardware() :	_gpio(),
						...
						_rmtRemoteControl(&_gpio, Gpio::GpioIndex::Gpio2, RmtChannel::RmtChannel1, Hal::BitsPerLed * Hal::MaxAddressableLeds, Hal::BitsPerLed),
						_leds(&_gpio, &_timer0, &_rmtRemoteControl),
